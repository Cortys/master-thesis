...
{\setlength{\parskip}{0}\paragraph{Spectral graph comparisons}
...
\begin{align}
	g_{\theta} * x_{G,j} = U_G^{\top}\, \hat{g}_{\theta}(\tfrac{2}{\max \lambda_{G}} \Lambda_G - I)\, U_G\, x_{G,j} = \hat{g}_{\theta}(\tfrac{2}{\max \lambda_{G}} L_G - I)\, x_{G,j} % chktex 21
\end{align}
