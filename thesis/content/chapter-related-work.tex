...
\begin{prop}[see \citet{Fuerer2017}]\label{prop:related:wl2-cycle-count}
	2-\acs{wl} is able to count $m$-cycles for $m \leq 6$ but it cannot detect 8-cycles.
	There are no results regarding 7-cycles.
\end{prop}
\begin{hproof}
	We refer to \citet{Fuerer2017} for the full proof.
	...
	Using a similar but more involved combinatorial argument requiring multiple color refinement steps, 5- and 6-cycle counting can be shown.
\end{hproof}
...
Lastly there are few results regarding the classes of distinguishable graphs and computable functions for higher \ac{wl}-dimensions.
For $k = 3$, \citet{Kiefer2017} have shown that all planar graphs can be distinguished.
