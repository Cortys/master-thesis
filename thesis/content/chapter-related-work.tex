...
Instead of explicity mapping a graph or vertices into a vector space, one can also do so implicity by employing the kernel trick.
...
We will now give a brief overview of the different types of \acp{gk}.

\subsubsection{R-Convolution Kernels}



\paragraph{Subgraph Pattern Kernel}

\paragraph{GraphInvariant Kernel}

\subsubsection{Non-Convolutional Kernels}

\paragraph{\acl{wl} Kernel}

\paragraph{Direct Product Kernel}
