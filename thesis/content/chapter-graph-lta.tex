...
\end{lem}
\begin{proof}
	Note that by \cfullref[ on ]{defn:related:laplacian-comb} it follows that $u_1 = \frac{1}{\sqrt{n}}{(1, \dots, 1)}^{\top}$ is an eigenvector with eigenvalue $\lambda_1 = 0$ of the combinatorial Laplacian as well as the symmetric normalized Laplacian\footnote{
		This is illustrated in \cfullref[ on ]{fig:related:graph-fourier}. We refer to \citet[section II.C.]{Shuman2013} for a more in-depth discussion of this fact.
	}.
