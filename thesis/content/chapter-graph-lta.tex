...
\end{lem}
\begin{proof}
	Note that by \cfullref[ on ]{defn:related:laplacian-comb} it follows that $u_1 = \frac{1}{\sqrt{n}}{(1, \dots, 1)}^{\top}$ is an eigenvector with eigenvalue $\lambda_1 = 0$ of the combinatorial Laplacian as well as the symmetrically normalized Laplacian.
