...
\Cref{tbl:eval:real} shows our evaluation results\footnote{
	...
	On average, each \ac{gnn} assessment (see \cref{algo:eval:assessment}) took about three days on an AMD 1800X 16-thread CPU and an Nvidia 1080~Ti GPU.% chktex 29
}.
