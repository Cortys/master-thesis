...
\newcommand*{\condbold}[2]{\ifthenelse{\equal{#1}{1}}{\mathbf{#2}}{#2}}
\newcommand*{\evalres}[3]{%
	\ifthenelse{\equal{#2}{m}}{\acs*{oom}}{%
	\ifthenelse{\equal{#2}{t}}{\acs*{oot}}{$\condbold{#1}{#2} \pm #3$}}%
}
