...
Synthetically generated data or some of the datasets listed in \cref{sec:related-work:tox} could be used for this.
Alternatively the sentiment analysis problem from \textit{natural language processing} (NLP) could be used by interpreting the dependency parse graph of a text as the input and the text's sentiment as its aggregate score.
