...
\begin{enumerate}[label=\textbf{\arabic*.}]
	\item \textbf{Aggregation:}
		...
		It should fulfill the role of the uninorms and OWA functions in the existing LTA papers.
	\item \textbf{Disaggregation:}
	...
	\item \textbf{Learning:}
		...
		This model should be optimizable reasonably efficiently on modern hardware.
...
In addition to the previous goals, the following goals should be pursued if possible:
\begin{itemize}
	\item
\end{itemize}
