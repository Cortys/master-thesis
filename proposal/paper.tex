...
The practical applications described in \cref{sec:related-work:gr} could be used for comparison and a potential source of a graph regression test dataset.
